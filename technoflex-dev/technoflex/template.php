 ...
 */
function technoflex_theme(&$existing, $type, $theme, $path) {
 ...
 * HTML preprocessing
 */
function technoflex_preprocess_html(&$vars) {
 ...
 */
function technoflex_process_html(&$variables) {
 ...
 */
function technoflex_preprocess_search_block_form(&$vars, $hook) {
